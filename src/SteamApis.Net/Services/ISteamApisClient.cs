...
public interface ISteamApisClient
{
    ...
    Task<InventoryResponse> GetUserSteamInventory(string steamId, int appId, int contextId, bool legacy = false, CancellationToken cancellationToken = default);
    ...
    Task<SteamProfileResponse> GetUserSteamProfile(string steamId, CancellationToken cancellationToken = default);
    ...
    Task<SteamVanityResponse> GetUserSteamVanity(string vanityName, CancellationToken cancellationToken = default);
    ...
    Task<SteamSummaryResponse> GetUserSteamSummary(string steamId, CancellationToken cancellationToken = default);
    ...
    Task<SteamGamesResponse> GetUserSteamGames(string steamId, CancellationToken cancellationToken = default);
    ...
    Task<GlobalStatsResponse> GetMarketStats(CancellationToken cancellationToken = default);
    ...
    Task<SteamAppDetailsResponse> GetSingleApp(int appId, CancellationToken cancellationToken = default);
    ...
    Task<SteamAppDetailsShortResponse[]> GetAllApps(CancellationToken cancellationToken = default);
    ...
    Task<SteamMarketItemResponse> GetSingleItem(int appId, string marketHashName, int medianHistoryDays = 15, CancellationToken cancellationToken = default);
    ...
    Task<AppItemsResponse> GetAllItems(int appId, CancellationToken cancellationToken = default);
    ...
    Task<Dictionary<string, double>> GetAllItemsCompact(int appId, CompactValue compactValue = CompactValue.Safe, CancellationToken cancellationToken = default);
    ...
    Task<SteamCardSetResponse> GetAllCards(CancellationToken cancellationToken = default);
    ...
    Task<MarketDescriptionsResponse> GetMarketDescriptions(int appId, int page = 1, CancellationToken cancellationToken = default);
    ...
    Task<MarketHistogramData[]> GetMarketHistograms(int appId, CancellationToken cancellationToken = default);
    ...
    Task<MarketAssetInfosResponse> GetMarketAssetInfos(int appId, string? cursor = null, CancellationToken cancellationToken = default);
    ...
    Task<byte[]> GetImage(int appId, string marketHashName, CancellationToken cancellationToken = default);
    ...
    Task<Dictionary<string, string>> GetImages(int appId, CancellationToken cancellationToken = default);
}